// src/pages/entry/MobileBulkInputForm.jsx
import React, { useState } from 'react';
import FormField from '../../components/common/FormField';
import { addBulkInput } from '../../services/bulkInputService';
import './EntryForm.css'; // Assuming this CSS file exists in the same 'entry' folder
...
export default MobileBulkInputForm; // <<<--- Default export එක මෙතන තියෙන්න ඕන